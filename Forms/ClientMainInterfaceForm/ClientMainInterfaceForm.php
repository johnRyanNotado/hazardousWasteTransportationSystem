...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="MainInterfaceForm.css">
    ...
    <main>
      ...
      <div class="action_box">
        <div class="action_container" style="background-color:rgb(186, 210, 159); ">
          <form class="createRequest_form" action="phpCodes/registerClientForm.php" method="post">

            <button class="action_buttons" type="submit" name="button">Register Client</button>
          </form>
        </div>
        <div class="action_container" style="background-color:rgb(186, 210, 159); ">
          <form class="cancelRequest_form" action="phpCodes/editClientForm.php" method="post">

            <button class="action_buttons" type="submit" name="button">Update Client</button>
          </form>
        </div>
